...
var ConversationsApiRequestFactory = (function (_super) {
    ...
    ConversationsApiRequestFactory.prototype.createPhoneCall = function (createCall, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (createCall === null || createCall === undefined) {
                            throw new baseapi_1.RequiredError("ConversationsApi", "createPhoneCall", "createCall");
                        }
                        localVarPath = '/conversations/create_phone_call';
    ...
    ConversationsApiRequestFactory.prototype.getAudioRecording = function (id, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (id === null || id === undefined) {
                            throw new baseapi_1.RequiredError("ConversationsApi", "getAudioRecording", "id");
                        }
                        localVarPath = '/conversations/{id}/recording'
    ...
    ConversationsApiRequestFactory.prototype.listConversations = function (status, createdBefore, createdAfter, index, limit, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        localVarPath = '/conversations';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        if (status !== undefined) {
                            requestContext.setQueryParam("status", ObjectSerializer_1.ObjectSerializer.serialize(status, "ConversationStatus", ""));
                        }
...
var ConversationsApiResponseProcessor = (function () {
    ...
    ConversationsApiResponseProcessor.prototype.createPhoneCallWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ConversationsApiResponseProcessor.prototype.getAudioRecordingWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, _o, _p;
            return __generator(this, function (_q) {
                switch (_q.label) {

...
exports.PhoneNumbersApiResponseProcessor = exports.PhoneNumbersApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var PhoneNumbersApiRequestFactory = (function (_super) {
    __extends(PhoneNumbersApiRequestFactory, _super);
    ...
    PhoneNumbersApiRequestFactory.prototype.getPhoneNumber = function (phoneNumber, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (phoneNumber === null || phoneNumber === undefined) {
                            throw new baseapi_1.RequiredError("PhoneNumbersApi", "getPhoneNumber", "phoneNumber");
                        }
                        localVarPath = '/phone_numbers/{phone_number}'
                            .replace('{' + 'phone_number' + '}', encodeURIComponent(String(phoneNumber)));
    ...
    return PhoneNumbersApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.PhoneNumbersApiRequestFactory = PhoneNumbersApiRequestFactory;
var PhoneNumbersApiResponseProcessor = (function () {
    ...
    PhoneNumbersApiResponseProcessor.prototype.getPhoneNumberWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, _o, _p;
            return __generator(this, function (_q) {
                switch (_q.label) {
    ...
    return PhoneNumbersApiResponseProcessor;
}());
exports.PhoneNumbersApiResponseProcessor = PhoneNumbersApiResponseProcessor;
//# sourceMappingURL=PhoneNumbersApi.js.map
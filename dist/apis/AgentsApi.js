...
exports.AgentsApiResponseProcessor = exports.AgentsApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var AgentsApiRequestFactory = (function (_super) {
    __extends(AgentsApiRequestFactory, _super);
    function AgentsApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AgentsApiRequestFactory.prototype.createAgent = function (agentConfiguration, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (agentConfiguration === null || agentConfiguration === undefined) {
                            throw new baseapi_1.RequiredError("AgentsApi", "createAgent", "agentConfiguration");
                        }
                        localVarPath = '/agents';
    ...
    return AgentsApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.AgentsApiRequestFactory = AgentsApiRequestFactory;
var AgentsApiResponseProcessor = (function () {
    function AgentsApiResponseProcessor() {
    }
    AgentsApiResponseProcessor.prototype.createAgentWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    AgentsApiResponseProcessor.prototype.deleteAgentWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, _o, _p;
            return __generator(this, function (_q) {
                switch (_q.label) {
    ...
    AgentsApiResponseProcessor.prototype.getAgentWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, _o, _p;
            return __generator(this, function (_q) {
                switch (_q.label) {
    ...
    AgentsApiResponseProcessor.prototype.listAgentsWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, _o, _p;
            return __generator(this, function (_q) {
                switch (_q.label) {
    ...
    AgentsApiResponseProcessor.prototype.updateAgentWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, _o, _p;
            return __generator(this, function (_q) {
                switch (_q.label) {
    ...
    return AgentsApiResponseProcessor;
}());
exports.AgentsApiResponseProcessor = AgentsApiResponseProcessor;
